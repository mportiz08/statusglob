class MainController < ApplicationController
  def index
    unless current_user.nil? || current_user.twitter_account.nil? || current_user.facebook_account.nil? || current_user.digg_account.nil? || current_user.delicious_account.nil?
